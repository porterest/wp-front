...
const ProfilePage: React.FC = () => {
  ...
  const handleCancelBet = async (betId: UUID) => {
    try {
      ...
      alert("Не удалось отменить ставку.");
    }
  };

  return (
      <div
          className="flex flex-col items-center justify-start min-h-screen bg-gradient-to-b from-black to-gray-900 text-white p-4 space-y-6">
        {/* Логотип */}
        <div className="mt-6">
