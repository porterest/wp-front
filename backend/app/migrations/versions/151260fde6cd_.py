...
Revision ID: 151260fde6cd
Revises: 
Create Date: 2024-12-26 00:28:52.092729
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'RESOLVED', name='betstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f('ix_bets_block_number'), 'bets', ['block_number'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_bets_block_number'), table_name='bets')
    op.drop_table('bets')
