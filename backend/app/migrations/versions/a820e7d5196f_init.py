...
def upgrade() -> None:
    ...
    op.create_table('app_wallets',
                    ...
                    sa.Column('wallet_type', sa.Enum('DEPOSIT', 'LIQUIDITY', 'RESERVE', name='wallettype'),
                              nullable=False),
    ...
    op.create_table('transactions',
                    ...
                    sa.Column('type', sa.Enum('INTERNAL_DEPOSIT', 'EXTERNAL_DEPOSIT', 'INTERNAL_WITHDRAWAL',
                                              'EXTERNAL_WITHDRAWAL', 'REWARD', 'SWAP', name='transactiontype'),
                              nullable=False),
    ...
    op.create_table('blocks',
                    ...
                    sa.Column('status', sa.Enum('COMPLETED', 'IN_PROGRESS', 'INTERRUPTED', name='blockstatus'),
                              nullable=False),
    ...
    op.create_table('deposit_entries',
                    ...
                    sa.Column('status', sa.Enum('PENDING', 'TIMED_OUT', 'FUNDED', 'SWAPPED', 'SUCCESS',
                                                name='depositentrystatus'), nullable=False),
