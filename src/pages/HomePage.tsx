...
const HomePage: React.FC = () => {
    ...
    const handlePlayNow = async () => {
        ...
        try {
            ...
            // Проверяем наличие proof в tonProof
            ...
            console.log("[HomePage]: Verification data prepared:", verificationData);
        ...
        <div className="flex flex-col items-center justify-between min-h-screen bg-black text-white">
            ...
            <div className="text-center px-6 mt-2">
                ...
                <p className="text-gray-300">
                    Explore a new world of crypto gambling. Connect your wallet to get started.
                </p>
            </div>
